...
-- https://medium.com/@gozdebarin/fundamentals-of-creating-and-updating-a-database-using-sql-3cebb5cb54
...
-- Does not run because customer_id is referenced as a foreign key 
-- To Delete would need to clean up other references

-- DELETE
-- FROM customers
-- WHERE customer_id = 1;

-- Doesn't run. Person table does not exist
-- DELETE p1
